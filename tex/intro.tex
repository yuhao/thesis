...
For the reasons state above my work chooses to adopt a client-centric approach. That said, future mobile Web computing systems will most likely incorporate certain aspects of cloud-offloading, which I discuss in \Sect{sec:conc}.
