...
\begin{figure}[t]
  \centering
  \includegraphics[trim=0 0 0 0, clip, width=.7\columnwidth]{ivso}
...
\begin{figure}[t]
  \centering
  \includegraphics[trim=0 0 0 0, clip, width=.7\columnwidth]{pareto_io}
...
\begin{figure}[t]
  \centering
  \includegraphics[trim=0 0 0 0, clip, width=.7\columnwidth]{pareto_ooo}
